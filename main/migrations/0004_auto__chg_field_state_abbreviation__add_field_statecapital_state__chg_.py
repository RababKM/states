...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StateCapital.longiude'
        db.alter_column(u'main_statecapital', 'longiude', self.gf('django.db.models.fields.FloatField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'StateCapital.longiude'
        db.alter_column(u'main_statecapital', 'longiude', self.gf('django.db.models.fields.FloatField')(default=1))
    ...
    models = {
        ...
        u'main.statecapital': {
            ...
            'longiude': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'}),
