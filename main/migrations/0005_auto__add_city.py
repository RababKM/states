...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_city', (
            ...
            ('longiude', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.StateCapital'], null=True)),
        ))
